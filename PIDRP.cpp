...
PID_RP::PID_RP(float P = 1.0, float I = 0.0, float D = 10.0, int Derivator = 0, int Integrator = 0,
        int Integrator_max = 250, int Integrator_min = -100, float set_point = 0.0, float power = 1.0){
